...
main( int argc, char **argv ) {
  ...
  fprintf(
    stdout,
    "Largest Z in nuclear collection is %d\n",
    p_my_nuclei->getLargestNucleonNumber( "z" )
  );
    
  fprintf(
    stdout,
    "Largest N in nuclear collection is %d\n",
    p_my_nuclei->getLargestNucleonNumber( "n" )
  );
    
  fprintf(
    stdout,
    "Largest A in nuclear collection is %d\n",
    p_my_nuclei->getLargestNucleonNumber( "a" )
  );
